...
@section('content')
    ...
    <p>
        <a href="{{ route('photos.thumbnails') }}" class="waves-effect waves-light btn">
            <i class="material-icons right">collections</i>Rebuild Thumbnails
        </a>
    </p>
    ...
    @forelse($photos as $photo)
        <div class="row">
            ...
            {{-- Photo --}}
            <div class="col s3">
                <img src="{{ $photo->getThumbnail() }}" class="responsive-img">
            </div>
