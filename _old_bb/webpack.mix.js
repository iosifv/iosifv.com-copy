...
mix.copy('resources/json-resume/generated/stackoverflow.pdf', 'public/resume.pdf');
mix.copy('resources/json-resume/generated/stackoverflow.html', 'public/resume.html');
...
// Fonts
// Todo: download fontawesome-6 and make sure this works
mix.copy('resources/assets/vendor/fontawesome-free-6.1.1-web/css/all.css', 'public/vendor/fontawesome-free/css/all.css');
mix.copyDirectory('resources/assets/vendor/fontawesome-free-6.1.1-web/webfonts', 'public/vendor/fontawesome-free/webfonts');
...
// NEW STUFF
mix.copyDirectory('resources/assets/rogan', 'public');
